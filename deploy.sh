...
APP_DISPLAY_NAME=${APP_DISPLAY_NAME:-"Promo Pulse: Bars & Timers"}
VERIFY_ENV_VARS=${VERIFY_ENV_VARS:-"SHOPIFY_APP_URL PROMO_PULSE_AI_PROVIDER SHOPIFY_ADVANCED_DISCOUNT_FUNCTION_HANDLE STOREFRONT_RATE_LIMIT_MAX_REQUESTS"}
VERIFY_ENV_SET_VARS=${VERIFY_ENV_SET_VARS:-"SHOPIFY_API_SECRET OPENAI_API_KEY EMAIL_PASS"}

...
> = {
  ...
  cartRescue: withLocaleOverrides({
    en: {
      headline: "Your cart deal expires soon",
      subheadline: "Complete checkout before this cart offer is gone.",
      ctaText: "Checkout now",
      expiredText: "This cart offer has ended.",
      badgeText: "Cart offer",
    },
    es: {
      headline: "Tu oferta del carrito termina pronto",
      subheadline: "Finaliza la compra antes de perder esta oferta.",
      ctaText: "Pagar ahora",
      expiredText: "Esta oferta del carrito termino.",
      badgeText: "Oferta carrito",
    },
    "pt-BR": {
      headline: "Sua oferta do carrinho termina em breve",
      subheadline: "Finalize a compra antes que esta oferta acabe.",
      ctaText: "Finalizar compra",
      expiredText: "Esta oferta do carrinho terminou.",
      badgeText: "Oferta no carrinho",
    },
    fr: {
      headline: "Votre offre panier expire bientot",
      subheadline: "Terminez la commande avant la fin de cette offre.",
      ctaText: "Commander",
      expiredText: "Cette offre panier est terminee.",
      badgeText: "Offre panier",
    },
    de: {
      headline: "Dein Warenkorb-Angebot endet bald",
      subheadline: "Schliesse den Kauf ab, bevor das Angebot endet.",
      ctaText: "Jetzt bezahlen",
      expiredText: "Dieses Warenkorb-Angebot ist beendet.",

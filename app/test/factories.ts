...
function createDesign(
  ...
  return {
    ...
    timerNumberLayout: DesignTimerNumberLayout.INLINE,
    ...
    closeButtonSize: 20,
    dismissBehavior: DesignDismissBehavior.SHOW_AGAIN,
    showButton: true,
    ...
    iconSize: 20,
    customIconUrl: "",
    iconBadgeMode: DesignIconBadgeMode.ICON,
    ...
    offerCodeLayout: DesignOfferCodeLayout.INLINE,

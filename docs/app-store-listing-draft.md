# Promo Pulse: Bars & Timers - App Store Listing Draft
...
Promo Pulse: Bars & Timers helps Shopify merchants launch real promotional
campaigns without editing theme code. Build countdown announcement bars, product
page timers, cart timers, free shipping goal bars, delivery cutoff messages,
low stock messages, and product badges from an embedded Shopify admin.

Use targeting rules for placements, products, collections, country, locale,
device, UTM source, and customer tags where Shopify context allows. Translate
campaign copy for English, Spanish, Portuguese (Brazil), French, and German.
Preview desktop and mobile designs before publishing.
...
- Countdown promo bars for top and bottom storefront placements.
- Product page timers through Shopify Theme App Blocks.
- Cart page and cart drawer timers.
- Free shipping goal bars with cart subtotal progress.
- Delivery cutoff timers with working days and holidays.
- Low stock messages that avoid fake inventory.
- Product badges for product or collection templates.
...
- Free: 1 active campaign, 5,000 impressions/month, countdown bar, basic
  product timer, and basic free shipping bar.
- Starter: $9/month, up to 5 active campaigns, 50,000 impressions/month,
  scheduling, recurring timers, basic targeting, and templates.
...
- Dashboard with campaign summary and onboarding checklist.
- Campaign list with filters and actions.
- Campaign editor showing Design & Preview.
- Translations tab with multiple locales.

    ...
    <div className="counterpulse-offers-workspace">
      {merchandisingOnlyTypes.has(campaignType) && (
        <AppAlert tone="warning" title="Some offer settings are optional">
          <p>
            {campaignTypeLabel} campaigns usually rely on Campaign and Design
            settings for the storefront presentation. Discount configuration
            remains available here, but unrelated discount fields are hidden
            inside each offer strategy.
          </p>
        </AppAlert>
      )}

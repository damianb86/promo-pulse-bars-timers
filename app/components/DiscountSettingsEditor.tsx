  ...
  return (
    <s-section heading="Discount">
      <p className="counterpulse-section-description">
        Choose whether this campaign has no shared discount, links to an
        existing Shopify discount, or creates one shared Shopify discount code.
      </p>
          ...
          <div className="counterpulse-form-grid">
            ...
            >
              <select
                ...
                value={mode}
                onChange={(event) =>
                  setMode(event.currentTarget.value as BasicDiscountModeValue)
                }
              >
            ...
            {isNoDiscount && (
              <div className="counterpulse-form-field counterpulse-form-field--full">
                ...
                >
                  <p>
                    This campaign will not promise or apply a discount. Use this
                    when the offer is only copy, urgency, merchandising, or an
                    email timer.
                  </p>
                </AppAlert>
              </div>

...
export function toCampaignDesignWriteData(
  ...
  return {
    ...
    iconBadgeMode: input.iconBadgeMode,
    iconBadgeText: input.iconBadgeText,
    iconBadgeShowGlyph: input.iconBadgeShowGlyph,
    iconBadgeBackgroundColor: input.iconBadgeBackgroundColor,
    iconBadgeTextColor: input.iconBadgeTextColor,
    iconBadgeFontSize: input.iconBadgeFontSize,
    iconBadgeBorderRadius: input.iconBadgeBorderRadius,
    splitDividerEnabled: input.splitDividerEnabled,
        ...
        ? {
            design: {
              create: {
                ...
                iconBadgeMode: campaign.design.iconBadgeMode,
                iconBadgeText: campaign.design.iconBadgeText,
                iconBadgeShowGlyph: campaign.design.iconBadgeShowGlyph,
                iconBadgeBackgroundColor:
                  campaign.design.iconBadgeBackgroundColor,
                iconBadgeTextColor: campaign.design.iconBadgeTextColor,
                iconBadgeFontSize: campaign.design.iconBadgeFontSize,
                iconBadgeBorderRadius: campaign.design.iconBadgeBorderRadius,
                splitDividerEnabled: campaign.design.splitDividerEnabled,
